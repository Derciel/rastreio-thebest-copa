...
*   **Integração de 9 Transportadoras & Motor SSW Inteligente**:
    ...
    *   **Canais Próprios**: Para as demais transportadoras (**Rodonaves**, **Expresso São Miguel**, **Carvalima** e **Alfa Transportes**), os botões apontam para os portais oficiais com instruções claras de cópia e colagem.
